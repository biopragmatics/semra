...
appreciated. See
[CONTRIBUTING.md](https://github.com/biopragmatics/semra/blob/main/.github/CONTRIBUTING.md)
...
1. Uses [bump-my-version](https://github.com/callowayproject/bump-my-version) to
   switch the version number in the `pyproject.toml`, `src/semra/version.py`,
